	...
	<div class="ratings-content">
		<div class="overview">
			<div class="overviewleft">
				...
				<div class="rank">高于平均{{seller.rankRate}}%</div>
			</div>
			<div class="overviewright">
				...
				<div class="score-wrapper">
					<span class="title">服务态度</span>
					<star :size='36' :score='seller.stampScore' class="star"></star>
					<span class="score">{{seller.stampScore}}</span>
				</div>
				<div class="delivery-wrapper">
					<span class="title">发货速度</span>
